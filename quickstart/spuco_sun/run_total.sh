python spuco_sun_jtt.py --root_dir /data/spucosun/6.0 --gpu 4 --lr 1e-5 --weight_decay 1e-4 --arch resnet50 --pretrained --wandb --num_epochs 40 --upsample_factor 70 --wandb_run_name jtt_6.0

python spuco_sun_jtt.py --root_dir /data/spucosun/6.1 --gpu 4 --lr 1e-5 --weight_decay 1e-4 --arch resnet50 --pretrained --wandb --num_epochs 40 --upsample_factor 70 --wandb_run_name jtt_6.1

python spuco_sun_jtt.py --root_dir /data/spucosun/6.2 --gpu 4 --lr 1e-5 --weight_decay 1e-4 --arch resnet50 --pretrained --wandb --num_epochs 40 --upsample_factor 70 --wandb_run_name jtt_6.2
